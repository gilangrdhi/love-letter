...
export default function LoveConfess() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-md sm:max-w-xl mx-auto text-center px-6 py-10 sm:px-10 sm:py-14 rounded-3xl border-2 border-pink-200 shadow-2xl bg-gradient-to-b from-pink-50 via-white to-pink-100"
    >
      {/* Border Glow */}
      <motion.div
        initial={{ opacity: 0 }}
      ...
      <motion.h1
        ...
        className="text-4xl sm:text-5xl font-[GreatVibes] text-pink-700 mb-6"
      >
      ...
      <motion.p
        ...
        className="font-[Lora] text-[16px] sm:text-lg text-gray-800 leading-loose tracking-wide"
      >
      ...
      <motion.div
        ...
        className="mt-10 text-2xl sm:text-3xl text-pink-500 font-[GreatVibes]"
      >
        💘 I love you 💘
      </motion.div>
      ...
      <motion.button
        ...
        onClick={handleNext}
        className="mt-10 px-8 py-3 bg-pink-500 hover:bg-pink-600 text-white font-semibold rounded-full shadow-md transition-all duration-300"
      >
        Lanjut ke Galeri 💌
      </motion.button>
    </motion.div>
